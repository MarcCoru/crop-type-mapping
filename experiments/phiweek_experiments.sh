...
for experiment in tumgaf_gaf_msresnet_optical tumgaf_gaf_tempcnn_optical tumgaf_gaf_transformer_optical tumgaf_gaf_rnn_optical; do
python train.py -x $experiment -e $epochs -b 96 -w 2 -i 0 --store /data/phiweek/runs --checkpoint_every_n_epochs 10 --test_every_n_epochs 1 --overwrite --no-visdom
done
