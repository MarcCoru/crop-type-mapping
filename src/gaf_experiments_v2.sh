...
echo $seed
for experiment in tumgaf_gaf_transformer_optical tumgaf_gaf_rnn_optical tumgaf_gaf_msresnet_optical tumgaf_gaf_tempcnn_optical tumgaf_tum_transformer tumgaf_tum_rnn tumgaf_tum_msresnet tumgaf_tum_tempcnn; do
python train.py -x $experiment -e $epochs -b 96 -w 2 -i 0 --store /data/gaf/runs$seed --checkpoint_every_n_epochs $epochs --test_every_n_epochs 1 --overwrite --no-visdom --seed $seed
done
