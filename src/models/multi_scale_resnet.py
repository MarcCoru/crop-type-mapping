...
class MSResNet(ClassificationModel):
    def __init__(self, input_channel, layers=[1, 1, 1, 1], num_classes=10, d_model=64):
        ...
        self.layer3x3_1 = self._make_layer3(BasicBlock3x3, 64, layers[0], stride=stride)
        self.layer3x3_2 = self._make_layer3(BasicBlock3x3, 128, layers[1], stride=stride)
        self.layer3x3_3 = self._make_layer3(BasicBlock3x3, 256, layers[2], stride=stride)
        ...
        self.layer5x5_1 = self._make_layer5(BasicBlock5x5, 64, layers[0], stride=stride)
        self.layer5x5_2 = self._make_layer5(BasicBlock5x5, 128, layers[1], stride=stride)
        self.layer5x5_3 = self._make_layer5(BasicBlock5x5, 256, layers[2], stride=stride)
