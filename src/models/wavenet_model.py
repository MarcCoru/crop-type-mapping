...
class WaveNetModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.start_conv = nn.Conv1d(in_channels=self.input_dims,
    ...
    def forward(self, input):
        ...
        return x.expand(n,T,c).contiguous(), None, None, None

    def predict(self, logprobabilities, deltas=None):
        return logprobabilities.argmax(-1)[:,0], None
